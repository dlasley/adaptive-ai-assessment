...
- **Teacher information**: Personal details about instructors (Mr. Ayon, etc.)
...
- How many languages does Mr. Ayon speak?
- How long has Mr. Ayon lived in France?
- What are Mr. Ayon's hobbies/interests?
- Questions about Mr. Ayon's books, marathon, favorite cartoons, etc.
...
cat data/questions.json | jq '[.[] | select(.question | test("Mr\\. Ayon"; "i"))] | length'
# Result: 0
```
